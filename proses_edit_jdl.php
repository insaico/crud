...
if ($_POST) {
    ...
    elseif (empty($matkul)) {
        echo "<script>alert('Matkul tidak boleh kosong!!!'); location.href='edit_jadwal.php'</script>";
    }
    elseif (empty($dosen)) {
        ...
        if ($update) {
            ...
            echo "<script>alert('Gagal update data Jadwal!!!'); location.href='edit_jadwal.php'</script>";
        }
    }
}